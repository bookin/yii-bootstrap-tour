jQuery(document).ready(function($){
	...
	function createNavigation(steps, n) {
		var tourNavigationHtml = '<div class="cd-navigation"><span><b class="cd-actual-step">1</b> of '+n+'</span><ul class="cd-tour-nav"><li><a href="#0" class="cd-prev">&#171; Previous</a></li><li><a href="#0" class="cd-next">Next &#187;</a></li></ul></div><a href="#0" class="cd-close">Close</a>';
